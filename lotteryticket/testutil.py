...
# Training loop
def train(model, train_loader, criterion, optimizer, epochs=6, device='cpu'):
...
def iterative_pruning( model, input_shape, output_shape, train_loader, prune_ratio, prune_iter, max_iter = 6, device='cpu'):
